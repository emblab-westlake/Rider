...
def parse_args():
    parser = argparse.ArgumentParser(description="Benchmark XGBoost Classifier.")
    parser.add_argument("--test_data", type=str, default=DEFAULT_TEST_DATA_PATH, help="Path to test data .pt file.")
    parser.add_argument("--model_path", type=str, default=DEFAULT_MODEL_PATH, help="Path to the .json model file.")
    parser.add_argument("--save_path", type=str, default="evaluation_results_xgb_3.npz", help="Path to save plotting data.")
...
def main():
    ...
    # XGBoost requires NumPy arrays on CPU
